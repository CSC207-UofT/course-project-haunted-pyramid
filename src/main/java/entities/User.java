...
public class User implements Serializable {
    ...
    public void setProcrastinate(boolean procrastinate){this.procrastinate = procrastinate;}
    public void setFreeTime(LocalTime start, LocalTime end){this.freeTime.put(start, end);}
    public void removeFreeTime(LocalTime start){this.freeTime.remove(start);}
